...
public:
	...
	void DrawError(vector<double>& data, vector<double>& data1, double data_x_min, double data_x_max, double data_y_min, double data_y_max, double E0, vector<double>& keys = vector<double>())
	{
		if (!init) return;
